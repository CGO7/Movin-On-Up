    ...
    function success(pos) {
        ...
        $.ajax({
            ...
            searchButton.click(function () {
                ...
                // Create list of search insights and loop over
                // let searchInsights
                ...
                $.ajax(settingsHouseholdincome).done(function (response1) {
                    console.log(zipcode);
                ...
                //     "async": true,
                //     "crossDomain": true,
                //     "url": "https://idealspot-geodata.p.rapidapi.com/api/v1/data/insights/salaries/query?location=" + encodedData + "&version=v2",
                //     "method": "GET",
                //     "headers": {
                //         // CHANGE OUT KEYS HERE ONCE ALL QUOTA USED UP!!!!!!!!!
                //         "x-rapidapi-key": "cc3bdfe5d0mshc16b581a0701a7ep103683jsn6aabd3b9dcb2",
                ...
                //     }
                // };
                // $.ajax(settingsSalary).done(function (response1) {
                //     console.log(zipcode);
                ...
                // // RUNS POPULATION ------------------------------------------------------
                // const settingsPopulation = {
                //     "async": true,
                //     "crossDomain": true,
                //     "url": "https://idealspot-geodata.p.rapidapi.com/api/v1/data/insights/residential-population/query?location=" + encodedData + "&version=v2",
                //     "method": "GET",
                //     "headers": {
                //         // CHANGE OUT KEYS HERE ONCE ALL QUOTA USED UP!!!!!!!!!
                //         "x-rapidapi-key": "cc3bdfe5d0mshc16b581a0701a7ep103683jsn6aabd3b9dcb2",
                ...
                //     }
                // };
                // $.ajax(settingsPopulation).done(function (response1) {
                //     console.log(zipcode);
                ...
                //     "async": true,
                //     "crossDomain": true,
                //     "url": "https://idealspot-geodata.p.rapidapi.com/api/v1/data/insights/crime/query?location=" + encodedData + "&version=v2",
                //     "method": "GET",
                //     "headers": {
                //         // CHANGE OUT KEYS HERE ONCE ALL QUOTA USED UP!!!!!!!!!
                //         "x-rapidapi-key": "cc3bdfe5d0mshc16b581a0701a7ep103683jsn6aabd3b9dcb2",
                ...
                //     }
                // };
                // $.ajax(settingsCrime).done(function (response1) {
                //     console.log(zipcode);
           ...
           var insights = function(Insight) {
            ...
            const settingsHouseholdincome = {
                "async": true,
                "crossDomain": true,
                "url": `https://idealspot-geodata.p.rapidapi.com/api/v1/data/insights/${Insight}/query?location=${encodedData}&version=v2`,
                "method": "GET",
                "headers": {
                    // CHANGE OUT KEYS HERE ONCE ALL QUOTA USED UP!!!!!!!!!
                    "x-rapidapi-key": "cc3bdfe5d0mshc16b581a0701a7ep103683jsn6aabd3b9dcb2",
